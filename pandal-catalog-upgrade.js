(() => {
  ...
  function replaceWithCleanControl(node) {
  ...
  function render() {
    ...
    if (!list) return;
    const search = document.querySelector('#pandal-search');
